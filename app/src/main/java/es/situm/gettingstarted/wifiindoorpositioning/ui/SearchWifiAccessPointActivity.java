...
import es.situm.gettingstarted.wifiindoorpositioning.adapter.WifiResultsAdapter;
...
//                refresh();
    ...
    private void initUI() {
        rvWifis = (RecyclerView) findViewById(R.id.rv_wifis);
        btnRefrsh = (Button) findViewById(R.id.btn_wifi_refresh);
