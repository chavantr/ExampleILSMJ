...
import es.situm.gettingstarted.wifiindoorpositioning.adapter.ReferenceReadingsAdapter;
...
public class AddOrEditReferencePointActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initUI() {
        ...
        rvPoints = (RecyclerView) findViewById(R.id.rv_points);
        ...
        bnRpSave = (Button) findViewById(R.id.bn_rp_save);
        ...
        etRpName = (EditText) findViewById(R.id.et_rp_name);
        etRpX = (EditText) findViewById(R.id.et_rp_x);
        etRpY = (EditText) findViewById(R.id.et_rp_y);
    }
