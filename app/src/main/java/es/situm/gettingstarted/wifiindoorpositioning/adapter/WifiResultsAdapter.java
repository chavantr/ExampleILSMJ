...
public class WifiResultsAdapter extends RecyclerView.Adapter<WifiResultsAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(LinearLayout v) {
            super(v);
            bssid = (TextView) v.findViewById(R.id.wifi_bssid);
            ssid = (TextView) v.findViewById(R.id.wifi_ssid);
            capabilities = (TextView) v.findViewById(R.id.wifi_capabilities);
            frequency = (TextView) v.findViewById(R.id.wifi_frequency);
            level = (TextView) v.findViewById(R.id.wifi_level);
        }
    }
