...
import es.situm.gettingstarted.wifiindoorpositioning.adapter.holder.AccessPointSection;
import es.situm.gettingstarted.wifiindoorpositioning.adapter.holder.ReferencePointSection;
import es.situm.gettingstarted.wifiindoorpositioning.model.AccessPoint;
import es.situm.gettingstarted.wifiindoorpositioning.model.IndoorProject;
import es.situm.gettingstarted.wifiindoorpositioning.model.ReferencePoint;
import es.situm.gettingstarted.wifiindoorpositioning.utils.RecyclerItemClickListener;
...
public class ProjectDetailActivity extends AppCompatActivity implements View.OnClickListener, RecyclerItemClickListener.OnItemClickListener {
    ...
    private void initUI() {
        pointRV = (RecyclerView) findViewById(R.id.rv_points);
        btnAddAp = (Button) findViewById(R.id.btn_add_ap);
        btnAddAp.setOnClickListener(this);

        btnAddRp = (Button) findViewById(R.id.btn_add_rp);
        btnAddRp.setOnClickListener(this);

        btnLocateMe = (Button) findViewById(R.id.btn_locate_me);
